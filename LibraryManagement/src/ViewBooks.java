...
public class ViewBooks extends JFrame {
    ...
    public ViewBooks() {
        ...
        JLabel lblViewBooksBy = new JLabel("Xem Sách");
        lblViewBooksBy.setFont(new Font("Verdana", Font.BOLD, 16));

        JLabel lblNewLabel_1 = new JLabel("Tìm sách theo");
        lblNewLabel_1.setFont(new Font("Verdana", Font.PLAIN, 13));

        String values[] = {"Chọn", "Tác giả", "Chủ đề", "Nhà xuất bản", "Thể loại", "Tất cả"};
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (name.equalsIgnoreCase("chọn")) {
                    JOptionPane.showMessageDialog(getParent(), "Vui lòng chọn một mục.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                }
                if (name.equalsIgnoreCase("tất cả")) {
                ...
                if (name.equalsIgnoreCase("chủ đề") || name.equalsIgnoreCase("tác giả") ||
                        name.equalsIgnoreCase("nhà xuất bản") || name.equalsIgnoreCase("thể loại")) {
        ...
        JLabel lblNewLabel_1_1 = new JLabel("Chọn mục");
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                String name = comboBox.getSelectedItem().toString();
                if (name.equalsIgnoreCase("tác giả")) {
                    comboBox_1.removeAllItems();
                    Vector<String> v = DBInfo.getValue("author");
                    for (String a : v) comboBox_1.addItem(a);
                }
                if (name.equalsIgnoreCase("chủ đề")) {
                    comboBox_1.removeAllItems();
                    Vector<String> v = DBInfo.getValue("subject");
                    for (String s : v) comboBox_1.addItem(s);
                }
                if (name.equalsIgnoreCase("nhà xuất bản")) {
                    comboBox_1.removeAllItems();
                    Vector<String> v = DBInfo.getValue("publisher");
                    for (String p : v) comboBox_1.addItem(p);
                }
                if (name.equalsIgnoreCase("thể loại")) {
                    comboBox_1.removeAllItems();
                    Vector<String> v = DBInfo.getValue("category");
                    for (String c : v) comboBox_1.addItem(c);
                }
            }
        });
