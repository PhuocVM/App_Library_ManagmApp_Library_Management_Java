...
public class ViewStatic extends JFrame {
    ...
    public ViewStatic() throws SQLException {
        setTitle("Xem sách đã mượn và đã trả");
        setResizable(false);
        ...
        String str[] = { "Chọn", "Mã sách", "Tên người dùng" };
        JFrame frame = new JFrame();

        setContentPane(contentPane);

        JLabel lblNewLabel_1 = new JLabel("Sách đã trả");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (value.equalsIgnoreCase("Chọn")) {
                    JOptionPane.showMessageDialog(getParent(), "Vui lòng chọn trường cần tìm.", "Lỗi",
                            JOptionPane.ERROR_MESSAGE);
                } else {
                    String str = JOptionPane.showInputDialog("Nhập " + value);
                    if (str == null || str.length() == 0) {
                        JOptionPane.showMessageDialog(getParent(), value + " không được để trống", "Lỗi nhập liệu",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    if (value.equalsIgnoreCase("Mã sách") || value.equalsIgnoreCase("Tên người dùng")) {
                        if (value.equalsIgnoreCase("Mã sách")) {
                            value = "bookId";
                        } else {
                            value = "username";
                        }
                        String query = "SELECT * FROM issueBooks WHERE " + value + "='" + str
                                + "' AND returnStatus='Submitted'";
                        try {
        ...
        JButton btnSearch = new JButton("Tất cả sách đã trả");
        ...
        JLabel lblNewLabel_1_1 = new JLabel("Sách đang mượn");
        ...
        JLabel lblNewLabel_2 = new JLabel("Tìm kiếm theo");
        ...
        JButton btnAllIssuedBooks = new JButton("Tất cả sách đang mượn");
        ...
        JButton btnRefresh_1 = new JButton("Làm mới");
                ...
                gl_contentPane.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl_contentPane.createSequentialGroup()
                                ...
                                .addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
                                        .addComponent(lblNewLabel_1, GroupLayout.DEFAULT_SIZE, 767, Short.MAX_VALUE)
                                        .addComponent(table, GroupLayout.DEFAULT_SIZE, 767, Short.MAX_VALUE)
                                        .addGroup(gl_contentPane.createSequentialGroup()
                                        ...
                                        .addComponent(table_1, GroupLayout.DEFAULT_SIZE, 767, Short.MAX_VALUE)
                                        .addGroup(gl_contentPane.createSequentialGroup()
